 ...
 * \file lspmgmtclean.h Sentinel Persistence Management API 
 *  declarations
 */

#ifndef _LSPMGMTCLEAN_H
#define _LSPMGMTCLEAN_H

/* H****************************************************************
* FILENAME    : lspmgmtclean.h
*
* DESCRIPTION :
...
*           creating applications that are being used to clean/reset
*           or manage persistence used by licensed application.
*
*H*/
...
enum sntl_persistence_device {
   ...
   SNTL_PERSISTENCE_NETWORK_DEVICE           = 2,
...
/*! \brief          Performs Persistence repair operation.
*
* \param            context           [in] The persistence context 
*                                          object.
* \param            persistence_scope [in] The "scope" for the repair
...
*                   'API Reference Guide' document.
*/
SNTL_DECLARE(sntl_persistence_status_t) sntl_persistence_repair(
                                           sntl_persistence_context_t *context,
                                           char                       *persistence_scope);

/*! \brief          Performs Persistence reset or cleanup operation.
*
* \param            context           [in] The persistence context 
*                                          object.
* \param            persistence_scope [in] The "scope" for the reset 
*                                          or cleanup operation. 
*                                          Based on the cleanup 
*                                          operation in scope, following
*                                          type of persistence is
*                                          cleaned:
*                                            Commuter,
*                                            Time-tamper
...
*                   'API Reference Guide' document.
*/
SNTL_DECLARE(sntl_persistence_status_t) sntl_persistence_reset(
                                           sntl_persistence_context_t  *context,
                                           char                        *persistence_scope);
